      ...
      <div className="gap-2 grid">
        <div>
          <Button color="primary" variant="ghost">
            <Link className="text-lg" href="/announcement6711">
        ...
        <div>
          <Button color="primary" variant="ghost">
            <Link className="text-lg" href="/announcement6710">
              เดือน ตุลาคม 2567
            </Link>
          </Button>
        </div>
        ...
        <div>
          <Button color="primary" variant="ghost">
            <Link className="text-lg" href="/announcement6705">
              เดือน พฤษภาคม 2567
            </Link>
          </Button>
        </div>
        <div>
          <Button color="primary" variant="ghost">
            <Link className="text-lg" href="/announcement6704">
              เดือน เมษายน 2567
            </Link>
          </Button>
        </div>
