    ...
    return NextResponse.json({
      ...
      attendances: logs.map((l) => {
        ...
        return {
          ...
          studentIdNum: student?.studentIdNum || student?.studentId || l.studentIdNum,
          classGroupId: standardizeClassGroupName(resolveStudentClassGroup(student) || l.classGroupId || ""),
