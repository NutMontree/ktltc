...
export async function GET() {
  try {
    ...
    users.sort((a, b) => {
      ...
      const isHeadA = (a.position || "").includes("หัวหน้า") || (a.position || "").includes("ผู้อำนวยการ") ? 0 : 1;
      const isHeadB = (b.position || "").includes("หัวหน้า") || (b.position || "").includes("ผู้อำนวยการ") ? 0 : 1;
