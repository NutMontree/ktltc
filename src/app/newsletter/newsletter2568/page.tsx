...
// 1. ข้อมูลจดหมายข่าวปี 2568 ครบทั้ง 12 เดือน
const newsletterItems = [
  {
    month: "ธันวาคม",
    year: "2568",
    href: "/newsletter/newsletter2568/newsletter6812",
  },
  {
    month: "พฤศจิกายน",
    year: "2568",
    href: "/newsletter/newsletter2568/newsletter6811",
  },
  {
    month: "ตุลาคม",
    year: "2568",
...
export default function Newsletter2568() {
  ...
  return (
    <section className="pb-20">
      {/* ส่วน Header (ดึงมาจาก page หลัก) */}
      <NewsletterPage />
      ...
      <div className="container mx-auto mt-12 max-w-5xl px-4 md:px-8">
        ...
        <div className="mb-8 flex items-center gap-3">
          ...
          <h2 className="text-2xl font-bold text-slate-800 dark:text-white">
            จดหมายข่าวประจำเดือน (พ.ศ. 2568)
          </h2>
        </div>

        {/* Grid Layout สำหรับ Card แต่ละเดือน */}
        <motion.div
