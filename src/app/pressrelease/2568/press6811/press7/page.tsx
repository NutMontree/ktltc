...
const TageFucntion = () => {
  return (
    <div>
      <div>
        <p className="text-lg text-sky-800">ดาวน์โหลดเอกสาร PDF</p>
        <Link
          href="/images/ข่าวประชาสัมพันธ์/2568/พฤศจิกายน/7/ร่างประกาศ ครุภัณฑ์ชุดฝึกการเขียนโปรแกรม.pdf"
          className="text-sky-500 hover:text-sky-600"
          target="_blank"
        >
          ร่างประกาศ ครุภัณฑ์ชุดฝึกการเขียนโปรแกรม
        </Link>
      </div>
    </div>
  );
