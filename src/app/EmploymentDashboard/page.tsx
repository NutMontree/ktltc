...
// ------------------------------------------------------------------
// ** การแก้ไข URL โดยใช้ Environment Variable (ส่วนที่ 1) **
// ------------------------------------------------------------------
const NEXT_PUBLIC_BASE_URL = process.env.NEXT_PUBLIC_BASE_URL || 'http://localhost:3000';

const getsuverys = async () => {
    try {
        // ใช้ NEXT_PUBLIC_BASE_URL เพื่อสร้าง Absolute URL
...
export default async function EmploymentDashboard() {
    ...
    return (
        // พื้นหลังอ่อนลง: bg-gray-50 -> bg-slate-50 หรือ bg-white/50
        <div className="min-h-screen bg-white/50 py-16 px-4 sm:px-6 lg:px-8">
            <div className="max-w-7xl mx-auto space-y-12">
                ...
                <div className="flex justify-between items-center pb-6 border-b border-gray-100">
                    ...
                    {/* ปุ่ม: ปรับสี, Shadow, Hover Effect */}
                    <Link
                        href="/suvery"
                ...
                {/* Main Content Card */}
                {/* เพิ่ม Shadow และ Rounded ให้ดูพรีเมียม */}
                <div className="bg-white shadow-2xl rounded-2xl overflow-hidden p-8 sm:p-10 border border-gray-100">
