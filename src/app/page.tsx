        ...
        <div className="max-w-[1600px] mx-auto w-full">
          ...
          <div className="py-12 flex justify-center">
            ...
            >
              <Link
                href="/student/verify"
                className="group relative inline-flex items-center justify-center gap-1.5 sm:gap-3 px-4 sm:px-8 py-2.5 sm:py-4 bg-linear-to-r from-blue-600 via-purple-600 to-pink-600 rounded-full text-white font-bold text-[11px] min-[375px]:text-xs sm:text-base md:text-lg shadow-2xl transition-all duration-300 overflow-hidden whitespace-nowrap w-auto"
              >
                ...
                <svg
                  className="w-4 h-4 min-[375px]:w-5 min-[375px]:h-5 sm:w-6 sm:h-6 shrink-0 relative z-10 group-hover:rotate-12 transition-transform duration-300"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
                ...
                <span className="relative z-10 text-center leading-tight">ระบบพิสูจน์ตัวตนนักเรียน นักศึกษา</span>
                <svg
                  className="w-4 h-4 sm:w-5 sm:h-5 shrink-0 relative z-10 group-hover:translate-x-1 transition-transform duration-300"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
