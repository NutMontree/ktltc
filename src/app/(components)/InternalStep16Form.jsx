...
const InternalStep16Form = ({ projectId, initialData = {} }) => {
  ...
  const [formData, setFormData] = useState({
    ...
    subject: initialData.subject || "รายงานสรุปการใช้งบประมาณ",
  ...
  const handleSave = async () => {
    setLoading(true);
    try {
      const res = await fetch(`/api/InternalPdcas/${projectId}/step16`, {
        method: "POST",
      ...
      <html>
        ...
        <body>
          ...
          <div class="para">
            ...
            จึงรายงานสรุปการใช้งบประมาณ ${clean(formData.projectName)}
  ...
  return (
    <div className="rounded-3xl border border-stroke bg-white p-8 shadow-xl dark:bg-boxdark">
      <div className="mb-8 flex items-center justify-between border-b pb-6">
        <h2 className="text-2xl font-black text-primary">บันทึกข้อความ รายงานสรุปการใช้งบประมาณ</h2>
            ...
            <div className="space-y-4 rounded-2xl bg-blue-50 p-6 shadow-inner">
              ...
              <div className="space-y-2 border-t border-blue-100 pt-4">
                ...
                <textarea
                  ...
                  placeholder="เช่น ได้รับมอบหมายให้ดำเนินการจัดซื้อวัสดุ... (จะแสดงก่อนคำว่า 'จึงรายงานสรุปการใช้งบประมาณ')"
                />
              </div>
            </div>
...
export default InternalStep16Form;
