...
const InternalInviteMemoForm = ({ projectId, initialData = {} }) => {
  ...
  const [formData, setFormData] = useState({
    ...
    subject: initialData.subject || "ขอเชิญประชุม",
  ...
  const handleSave = async () => {
    setLoading(true);
    try {
      const res = await fetch(`/api/InternalPdcas/${projectId}/step8`, {
        method: "POST",
      ...
      <html>
        ...
        <body>
          ...
          <div class="para">
            ...
            จึงขอเชิญประชุม ${clean(formData.projectName)}
  ...
  return (
    <div className="rounded-3xl border border-stroke bg-white p-8 shadow-xl dark:bg-boxdark">
      <div className="mb-8 flex items-center justify-between border-b pb-6">
        <h2 className="text-2xl font-black text-primary">บันทึกข้อความ ขอเชิญประชุม</h2>
      ...
      <div className="space-y-10">
            ...
            <div className="space-y-4 rounded-2xl bg-blue-50 p-6 shadow-inner">
              ...
              <div className="space-y-2 border-t border-blue-100 pt-4">
                ...
                <textarea
                  ...
                  placeholder="เช่น ได้รับมอบหมายให้ดำเนินการจัดซื้อวัสดุ... (จะแสดงก่อนคำว่า 'จึงขอเชิญประชุม')"
                />
              </div>
            </div>
            ...
            <div className="mt-4 rounded-2xl border-2 border-primary/20 bg-primary/5 p-6 shadow-inner">
              ...
              <div className="space-y-4 text-lg leading-relaxed text-gray-700">
                ...
                <div>
                  ...
                  <span className="font-bold text-primary underline">จึงขอเชิญประชุม</span>{" "}
        ...
        <div className="mt-10 border-t pt-10 text-center">
          ...
          >
            {loading ? "กำลังบันทึก..." : "บันทึกข้อมูล (Step 8)"}
          </button>
        </div>
      </div>
...
export default InternalInviteMemoForm;
