...
const InternalStep19Form = ({ projectId, initialData = {} }) => {
  ...
  const [formData, setFormData] = useState({
    ...
    subject: initialData.subject || "รายงานสรุปผลการวิเคราะห์ข้อมูลการดำเนินโครงการ",
    ...
    deputy2Position: initialData.deputy2Position || "รองผู้อำนวยการฝ่ายยุทธศาสตร์และแผนงาน",
  ...
  const handleSave = async () => {
    setLoading(true);
    try {
      const res = await fetch(`/api/InternalPdcas/${projectId}/step19`, {
        method: "POST",
      ...
      <html>
        ...
        <body>
          ...
          <div class="para">
            ...
            จึงรายงานสรุปผลการวิเคราะห์ข้อมูลการดำเนินโครงการ ${clean(formData.projectName)}
    ...
    <div className="rounded-3xl border border-stroke bg-white p-8 shadow-xl dark:bg-boxdark">
      <div className="mb-8 flex items-center justify-between border-b pb-6">
        <h2 className="text-2xl font-black text-primary">
          บันทึกข้อความ รายงานสรุปผลการวิเคราะห์ข้อมูลการดำเนินโครงการ
        </h2>
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4 rounded-2xl bg-blue-50 p-6 shadow-inner">
              ...
              <div className="space-y-2 border-t border-blue-100 pt-4">
                ...
                <textarea
                  ...
                  placeholder="เช่น ได้รับมอบหมายให้ดำเนินการจัดซื้อวัสดุ... (จะแสดงก่อนคำว่า 'จึงรายงานสรุปผลการวิเคราะห์ข้อมูลการดำเนินโครงการ')"
                />
              </div>
            </div>
            ...
            <div className="mt-4 rounded-2xl border-2 border-primary/20 bg-primary/5 p-6 shadow-inner">
              ...
              <div className="space-y-4 text-lg leading-relaxed text-gray-700">
                ...
                {formData.paragraphs[0] && formData.paragraphs[0].trim() !== "" && (
                  <div>
                ...
                <div>
                  ...
                  {(formData.departmentName || "ระบุชื่อแผนก")
                    .trim()
                    .replace(/^[ \u0e48-\u0e4b|'‘’"“”]+/g, "")}{" "}
                  <span className="italic">{formData.additionalIntroText || ""}</span>{" "}
                  <span className="font-bold text-primary underline">
                    จึงรายงานสรุปผลการวิเคราะห์ข้อมูลการดำเนินโครงการ
                  </span>{" "}
...
export default InternalStep19Form;
