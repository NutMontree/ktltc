...
export default function page() {
    return (
        <>
            ...
            <div> <LinkPreview url='/images/ita/pdf/o33-แนวทางการจัดกิจกรรมเสริมสร้างสุจริต.pdf'> <p className='hover:text-orange-500 dark:hover:text-orange-400'>1. แนวทางการจัดกิจกรรมเสริมสร้างสุจริต จิตอาสา ระดับประกาศนียบัตรวิชาชีพชั้นสูง (ปวส)</p> </LinkPreview> </div>
        </>
    )
}
