...
const InternalStep16Schema = new mongoose.Schema(
  {
    projectId: { type: mongoose.Schema.Types.ObjectId, ref: "InternalPdca", required: true },
    docNumber: String,
    date: String,
    subject: { type: String, default: "รายงานสรุปการใช้งบประมาณ" },
...
export default mongoose.models.InternalStep16 ||
  mongoose.model("InternalStep16", InternalStep16Schema);
