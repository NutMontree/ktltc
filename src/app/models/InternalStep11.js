...
const InternalStep11Schema = new mongoose.Schema(
  {
    projectId: { type: mongoose.Schema.Types.ObjectId, ref: "InternalPdca", required: true },
    docNumber: String,
    date: String,
    subject: { type: String, default: "รายงานการประชาสัมพันธ์โครงการ" },
...
export default mongoose.models.InternalStep11 ||
  mongoose.model("InternalStep11", InternalStep11Schema);
