...
const InternalStep21Schema = new mongoose.Schema(
  {
    projectId: { type: mongoose.Schema.Types.ObjectId, ref: "InternalPdca", required: true },
    docNumber: String,
    date: String,
    subject: { type: String, default: "รายงานสรุปผลการดำเนินโครงการ" },
...
export default mongoose.models.InternalStep21 ||
  mongoose.model("InternalStep21", InternalStep21Schema);
