...
const InternalInviteMemoSchema = new mongoose.Schema(
  {
    projectId: { type: mongoose.Schema.Types.ObjectId, ref: "InternalPdca", required: true },
    docNumber: String, // ที่
    date: String, // วันที่
    subject: { type: String, default: "ขอเชิญประชุม" }, // เรื่อง
...
export default mongoose.models.InternalInviteMemo ||
  mongoose.model("InternalInviteMemo", InternalInviteMemoSchema);
