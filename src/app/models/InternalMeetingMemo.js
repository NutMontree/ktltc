...
const InternalMeetingMemoSchema = new mongoose.Schema(
  {
    projectId: { type: mongoose.Schema.Types.ObjectId, ref: "InternalPdca", required: true },
    docNumber: String, // ที่
    date: String, // วันที่
    subject: { type: String, default: "ขออนุญาตประชุม" }, // เรื่อง
...
export default mongoose.models.InternalMeetingMemo ||
  mongoose.model("InternalMeetingMemo", InternalMeetingMemoSchema);
