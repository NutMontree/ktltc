      ...
      >
        ...
        <div className="container">
          <div className="relative -mx-4 flex items-center justify-between ">
            ...
            <div className="w-20 pt-2 px-2 max-w-full ">
              <div className="">
                  ...
                  {pathUrl !== "/" ? (
                    <>
                      <Image
                        ...
                        width='240'
                        height='30'
                        className="header-logo w-full dark:hidden hidden lg:block pt-2"
                      />
                      <Image
                        src={`/images/logo.webp`}
                        alt="logo"
                        width='240'
                        height='30'
                        className="header-logo hidden w-full dark:block pt-2"
                      />
                    </>
                  ) : (
                    <>
                      <Image
                        ...
                        width='140'
                        height='30'
                        className="header-logo w-full hidden lg:block pt-2"
                      />
                      <Image
                        src={"/images/logo.webp"}
                        alt="logo"
