                ...
                <div className="">
                  ...
                  <div className="text-[10px] md:text-[12px] sm:text-sm md:text-base lg:text-base ">
                    <div className="px md:px-8 pt-2">
                      ...
                      เปิดรับสมัครนักเรียน นักศึกษา โควตารอบที่ 3
                      (โควตารอบสุดท้าย) ประจำปีการศึกษา 2568 <br />
                      ****สามารถสมัครได้ตั้งเเต่วันนี้ถึงวันที่ 28 กุมภาพันธ์ 2568
                      ณ ห้องงานทะเบียน ตึกอำนวยการวิทยาลัยเทคนิคกันทรลักษ์ <br />
                      **หมายเหตุ สมัครพร้อมมอบตัวทันที โดยมีค่าใช้จ่ายในการมอบตัว
                      ดังนี้
                      <br />
                      - ระดับประกาศนียบัตรวิชาชีพ (ปวช.) 1,170. -<br />
                      - ระดับประกาศนียบัตรวิชาชีพชั้นสูง (ปวส.) 1,570. - <br />
