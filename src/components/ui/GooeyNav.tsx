...
interface GooeyNavItem {
  ...
  id?: string;
  href?: string;
  onClick?: (item: GooeyNavItem, index: number) => void;
}
...
const GooeyNav: React.FC<GooeyNavProps> = ({
  ...
  const handleClick = (e: React.MouseEvent<HTMLAnchorElement> | { currentTarget: HTMLElement; preventDefault: () => void }, index: number) => {
    e.preventDefault();
    ...
    if (items[index] && items[index].onClick) {
      items[index].onClick!(items[index], index);
    }
