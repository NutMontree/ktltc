              ...
              <div className="mb-12 flex flex-wrap justify-between lg:mb-0">
                ...
                <div className="mb-8 flex w-[330px] max-w-full">
                  ...
                  <div>
                    ...
                    <p className="text-body-color dark:text-black-6 mt-1 text-base">
            ...
            >
              ...
              <form>
                <div className="mb-[22px]">
                  <label
                    htmlFor="fullName"
                    className="text-body-color dark:text-black-6 mb-4 block text-sm"
                  >
                    Full Name*
                  </label>
                  <input
                    ...
                    className="placeholder:text-body-color/60 focus:border-primary dark:border-dark-3 w-full border-0 border-b border-[#f1f1f1] bg-transparent pb-3 text-black focus:outline-none dark:text-white"
                  />
                </div>
                <div className="mb-[22px]">
                  <label
                ...
                <div className="mb-[30px]">
                  ...
                  <textarea
                    ...
                    className="placeholder:text-body-color/60 focus:border-primary dark:border-dark-3 w-full resize-none border-0 border-b border-[#f1f1f1] bg-transparent pb-3 text-black focus:outline-none dark:text-white"
                  ></textarea>
                </div>
                <div className="mb-0">
                  <button
