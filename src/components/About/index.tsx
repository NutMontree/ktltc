          ...
          <div className="-mx-4 flex flex-wrap items-center">
            <div className="w-full lg:w-1/2">
              <div className="mb-12 max-w-[540px] lg:mb-0">
                ...
                <div className="text-body-color dark:text-black-6 mb-10 text-base leading-relaxed">
                  ...
                  >
                    <div className="hover:text-sky-500">
                      <div>
                        <p className="pt-2 text-[14px] hover:text-sky-500 sm:text-sm md:text-base md:text-[20px]">
                          ที่ตั้ง/GPS
                        </p>
                      </div>
                    </div>
