...
export default function MagicRings({
  ...
  useEffect(() => {
    ...
    const animate = (t: number) => {
      ...
      if (p.color) uniforms.uColor.value.set(p.color);
      if (p.colorTwo) uniforms.uColorTwo.value.set(p.colorTwo);
  ...
  return <div ref={mountRef} className="magic-rings-container" style={blur && blur > 0 ? { filter: `blur(${blur}px)` } : undefined} />;
}
