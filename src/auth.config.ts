...
const callbacks: NextAuthConfig["callbacks"] = {
  ...
  async jwt({ token, user }) {
    ...
    // หมายเหตุ: ย้ายตรรกะ Revalidation (เช็ค 15 นาที) ไปไว้ที่ src/lib/auth.ts เพื่อเลี่ยงปัญหา Deadlock/Timeout
    // ใน Next.js Middleware ที่เกิดจากการยิง fetch หาตัวเอง
    return token;
  },
